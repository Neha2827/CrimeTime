...
public class userComplainAdapter extends FirestoreRecyclerAdapter <ComplainClass, userComplainAdapter.Holder>{
    ...
    public userComplainAdapter(@NonNull FirestoreRecyclerOptions<ComplainClass> options) {
        super(options);
    }
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.card_complain,parent,false);
